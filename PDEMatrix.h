...
class PDEMatrix : virtual public Matrix<T>
{
  public:
    ...
    // Desc: Returns the granularity of the matrix mesh
    // Pre: None
    // Post: The mesh size of the matrix is returned
     virtual long GetN() const;
